...
class ThingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create thing" do
    assert_difference('Thing.count') do
      post things_url, params: { thing: { category: @thing.category, description: @thing.description, title: @thing.title } }
    end
  ...
  test "should update thing" do
    patch thing_url(@thing), params: { thing: { category: @thing.category, description: @thing.description, title: @thing.title } }
